...
| [`/web-search`](#web-search) | **Researcher** | Web search — real results, each scraped to clean markdown inline so you answer with citations. Pairs with `$B fetch <url>` for faithful URL→markdown. |
